...
update `quest_template` set `RequiredMinRepValue`='3000',`RepRevValue1`='250',`RepRevValue2`='250' where `entry` in (7163,7168);
update `quest_template` set `RequiredMinRepValue`='9000',`RepRevValue1`='250',`RepRevValue2`='250' where `entry` in (7164,7169);
update `quest_template` set `RequiredMinRepValue`='21000',`RepRevValue1`='350',`RepRevValue2`='350' where `entry` in (7165,7170);
update `quest_template` set `RequiredMinRepValue`='42000',`RepRevValue1`='500',`RepRevValue2`='500' where `entry` in (7166,7171);
update `quest_template` set `RequiredMinRepValue`='42999',`RepRevValue1`='500',`RepRevValue2`='500' where `entry` in (7167,7172);
